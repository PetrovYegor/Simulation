...
//        }
        board.setEntity(new Coordinates(3, 3), new Predator(new Coordinates(3, 3), CreatureUtils.getRandomSpeed(), CreatureUtils.getRandomHealth(), CreatureUtils.getRandomAttackPower()));
    }
}